...
public class SalesRecordsController {
    ...
    public @ResponseBody ResponseEntity<Page<SalesRecord>> listSalesRecords() {
    ...
    public @ResponseBody ResponseEntity<SalesRecord> getSalesRecords(@PathVariable("orderId") Long orderId) {
        SalesRecord salesRecord = salesRecordsService.getSalesRecords(orderId);
